...
prod_list[0].read_production('Releve_AntonySoleil\\Simu_Prod.csv')
...
cons_list[1].read_consumption('Releve_AntonySoleil\\Simu_5Conso.csv')
cons_list[2].read_consumption('Releve_AntonySoleil\\1_1ParvisDuBreuil_PRM_30002130432283_V2.csv')
cons_list[3].read_consumption('Releve_AntonySoleil\\2_2ParvisDuBreuil_PRM_30002130432722_V2.csv')
cons_list[4].read_consumption('Releve_AntonySoleil\\3_3ParvisDuBreuil_PRM_30002130426648_V2.csv')
cons_list[5].read_consumption('Releve_AntonySoleil\\1_1ParvisDuBreuil_PRM_30002130432283_V2.csv')
cons_list[6].read_consumption('Releve_AntonySoleil\\2_2ParvisDuBreuil_PRM_30002130432722_V2.csv')
cons_list[7].read_consumption('Releve_AntonySoleil\\3_3ParvisDuBreuil_PRM_30002130426648_V2.csv')
cons_list[8].read_consumption('Releve_AntonySoleil\\Simu_PtiteEchoppe.csv')
cons_list[9].read_consumption('Releve_AntonySoleil\\Simu_Azimut.csv')
...
rep.generate_graph(prod_list, cons_list)
