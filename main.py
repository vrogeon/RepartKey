...
cons_list.append(Consumer.Consumer('Cons1',12345678900001, [ 0 ], [ 40 ]))
cons_list.append(Consumer.Consumer('Cons2',12345678900002, [ 0 ], [ 30 ]))
cons_list.append(Consumer.Consumer('Cons3',12345678900003, [ 0 ], [ 30 ]))
