...
#
# rep.generate_monthly_report(prod_list, cons_list, add_cons_mois = False, add_ratio = False)
#
...
Graph.generate_area('1234567901000_statistics.csv',';')

Graph.generate_month_graph('1234567901000_monthly_report.csv', ';')