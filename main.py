...
Graph.generate_graph('1234567901000_statistics.csv',';', group=False, resolution='month')
Graph.generate_graph('1234567901000_statistics.csv',';', group=False, resolution='day')
#Graph.generate_graph('1234567901000_statistics.csv',';', group=False, resolution='hour')
